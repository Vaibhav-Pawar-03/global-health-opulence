...
export default function Treatment() {
  const items = [
    {
      title: "Gallbladder and Appendix Removal",
      img: "/Laparoscopic Surgery.png",
    },
    {
      title: "Hernia and Bariatric Procedures",
      img: "/Bariatric.png",
    },
    {
    ...
    {
      title: "Diagnostic Laparoscopy and Endoscopic Interventions",
      img: "/Laparoscopic Surgery.png",
    },
    {
    ...
    <div className="w-full bg-white">
      <section className="max-w-7xl mx-auto px-6">
        ...
        <p className="text-sm font-semibold text-gray-600">
          <span className="text-[#1073B9]">Services</span> &nbsp;›&nbsp; Laparoscopic Surgery
        </p>
