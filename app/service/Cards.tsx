...
const treatments = [
  ...
  {
    title: "Robotic and Minimally Invasive Surgery",
    desc: "Robotic systems deliver unmatched surgical precision with minimal pain, faster healing & improved functional outcomes across multiple specialties including oncology, urology, orthopaedics, and gastroenterology.",
    icon: "/S12.png",
  },
];
      ...
      {/* Cards Grid */}
        <div className="w-full max-w-6xl grid grid-cols-1 sm:grid-cols-2 gap-10 px-3">
            {visibleCards.map((item, index) => (
             <div
                 key={index}
                className="bg-white rounded-[32px] p-6 shadow-md hover:shadow-xl transition-all duration-300 flex items-start gap-6"
             >
      {/* Icon */}
