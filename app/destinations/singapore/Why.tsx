...
export interface WhyChooseSingaporeProps {
  title?: string;
  description?: string;
  imageSrc?: string;
  imgAlt?: string;
...
const WhyChooseSingapore: FC<WhyChooseSingaporeProps> = ({
  title = "Why Choose Singapore with Global Health Opulence",
  description =
    "Global Health Opulence ensures a seamless journey through Singapore healthcare travel, managing everything from medical appointments to luxury accommodation. Partner institutions combine diagnostic precision, patient privacy, and holistic care. Choose Global Health Opulence to experience Singapore's unmatched medical precision where every detail is designed for your comfort, care, and confidence.",
  imageSrc = "/Doctor.png",
  imgAlt = "Doctor",
}) => {
...
export default WhyChooseSingapore;
