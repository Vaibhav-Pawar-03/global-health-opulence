...
export interface WhyChooseTurkeyProps {
  title?: string;
  description?: string;
  imageSrc?: string;
  imgAlt?: string;
...
const WhyChooseTurkey: FC<WhyChooseTurkeyProps> = ({
  title = "Why Choose Türkiye with Global Health Opulence",
  description =
    "Through Global Health Opulence, your Türkiye healthcare travel experience is refined to the highest international standards. We partner exclusively with accredited hospitals and leading specialists to ensure uncompromising quality, privacy, and comfort. Our concierge-style coordination includes medical planning, visa and travel assistance, private transfers, and luxury recovery stays. Each stage of your journey is handled with discretion and precision — ensuring you receive world-class care, seamlessly delivered.",
  imageSrc = "/Doctor.png",
  imgAlt = "Doctor",
}) => {
