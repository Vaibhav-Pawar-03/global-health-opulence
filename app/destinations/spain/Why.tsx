...
export interface WhyChooseSpainProps {
  title?: string;
  description?: string;
  imageSrc?: string;
  imgAlt?: string;
...
const WhyChooseSpain: FC<WhyChooseSpainProps> = ({
  title = "Why Choose Spain with Global Health Opulence",
  description =
    "Global Health Opulence simplifies every aspect of Spain healthcare travel, coordinating world-class medical care, language assistance, and curated stays in accredited recovery facilities. Our partner institutions combine European standards with personal attention. Trust Global Health Opulence to craft your journey through Spain, where excellence, culture, and wellbeing unite to deliver a restorative experience beyond compare.",
  imageSrc = "/Doctor.png",
  imgAlt = "Doctor",
}) => {
