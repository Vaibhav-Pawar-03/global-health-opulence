...
export interface WhyChooseThailandProps {
  title?: string;
  description?: string;
  imageSrc?: string;
  imgAlt?: string;
...
const WhyChooseThailand: FC<WhyChooseThailandProps> = ({
  title = "Why Choose Thailand with Global Health Opulence",
  description =
    "With Global Health Opulence, your Thailand healthcare travel experience is designed for comfort, privacy, and complete coordination. Our partnerships with accredited hospitals, experienced specialists, and local patient coordinators ensure medical and logistical support from consultation to recovery. We handle visa arrangements, travel logistics, and accommodation, along with continued virtual follow-up once you return home. GHO ensures your medical journey in Thailand is effortless, safe, and deeply restorative.",
  imageSrc = "/Doctor.png",
  imgAlt = "Doctor",
}) => {
...
export default WhyChooseThailand;
