...
export interface WhyChooseMexicoProps {
  title?: string;
  description?: string;
  imageSrc?: string;
  imgAlt?: string;
...
const WhyChooseMexico: FC<WhyChooseMexicoProps> = ({
  title = "Why Choose Mexico with Global Health Opulence",
  description =
    "Through Global Health Opulence, your Mexico healthcare travel experience combines convenience, quality, and value. We partner with JCI-accredited hospitals and board-certified specialists throughout Mexico to ensure exceptional care close to home. Our comprehensive coordination includes medical consultations, border logistics, bilingual support, and comfortable accommodations. With direct flights from major US cities and minimal time zone differences, Mexico offers accessible excellence without compromise.",
  imageSrc = "/Doctor.png",
  imgAlt = "Doctor",
}) => {
...
export default WhyChooseMexico;
