...
export interface WhyChooseIndiaProps {
  title?: string;
  description?: string;
  imageSrc?: string;
  imgAlt?: string;
...
const WhyChooseIndia: FC<WhyChooseIndiaProps> = ({
  title = "Why Choose India with Global Health Opulence",
  description =
    "Through Global Health Opulence, your India healthcare travel experience is personalised from consultation to recovery. Our partnerships with JCI-accredited hospitals and leading specialists ensure uncompromising safety, transparency, and comfort. Dedicated patient stewards coordinate every step — from visa facilitation and transfers to private recovery arrangements and ongoing virtual follow-ups. With GHO, international care becomes effortless, discreet, and deeply restorative.",
  imageSrc = "/Doctor.png",
  imgAlt = "Doctor",
}) => {
