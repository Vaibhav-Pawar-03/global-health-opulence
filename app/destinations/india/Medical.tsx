...
export default function IndiaDestinations() {
  const cards = [
    {
      title: "New Delhi",
      desc: "The nation's capital and a medical epicentre housing India's most reputed multi-speciality hospitals.",
      img: "/DM1.png",
    },
    {
      title: "Mumbai",
      desc: "A global gateway for advanced treatments, luxury stays, and leading cosmetic and oncology care.",
      img: "/DM2.png",
    },
    {
      title: "Chennai",
    ...
    {
      title: "Bengaluru",
      desc: "A modern health technology hub offering minimally invasive and robotic procedures.",
      img: "/DM1.png",
    },
  ];
  ...
  return (
    <section className="w-full py-16 px-6 md:px-24 bg-white">
      ...
      <h2 className="text-3xl md:text-4xl font-bold text-[#002147] mb-12">
        ...
        <span className="text-[#25282B]">in India</span>
      </h2>
