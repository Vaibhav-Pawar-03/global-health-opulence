...
export interface WhyChooseVietnamProps {
  title?: string;
  description?: string;
  imageSrc?: string;
  imgAlt?: string;
...
const WhyChooseVietnam: FC<WhyChooseVietnamProps> = ({
  title = "Why Choose Vietnam with Global Health Opulence",
  description =
    "With Global Health Opulence, your journey through Vietnam healthcare travel is guided by a dedicated patient experience team ensuring seamless coordination from consultation to return. Each itinerary is curated for privacy, cultural comfort, and clinical excellence. Our partner hospitals meet international standards for technology, safety, and ethics. From visa assistance to recovery planning, every stage is thoughtfully managed to enhance both treatment outcomes and travel comfort.",
  imageSrc = "/Doctor.png",
  imgAlt = "Doctor",
}) => {
