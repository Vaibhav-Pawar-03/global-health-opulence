...
export default function BrazilDestinations() {
  const cards = [
    {
      title: "São Paulo",
      desc: "The nation’s healthcare capital, home to top-ranked hospitals and global research facilities.",
      img: "/DM1.png",
    },
    {
      title: "Rio de Janeiro",
      desc: "Known for world-class cosmetic and wellness centres with serene recovery resorts.",
      img: "/DM2.png",
    },
    {
      title: "Brasilia",
      desc: "A hub for cardiovascular and orthopaedic expertise.",
      img: "/DM3.png",
    },
    // Duplicate for 6-card carousel
    {
      title: "São Paulo (Mock)",
      desc: "Mock card for carousel continuity.",
      img: "/DM1.png",
    },
    {
      title: "Rio de Janeiro (Mock)",
      desc: "Mock card for carousel continuity.",
      img: "/DM2.png",
    },
    {
  ...
  return (
    <section className="w-full py-16 px-6 md:px-24 bg-white">
      ...
      <h2 className="text-3xl md:text-4xl font-bold text-[#002147] mb-12">
        ...
        <span className="text-[#25282B]">In Brazil</span>
      </h2>
        ...
        >
          {cards.map((card, i) => (
            ...
            >
              ...
              {/* Bottom Gradient (bigger so text stays bottom) */}
              <div
