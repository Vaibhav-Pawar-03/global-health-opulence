...
export interface WhyChooseGermanyProps {
  title?: string;
  description?: string;
  imageSrc?: string;
  imgAlt?: string;
...
const WhyChooseGermany: FC<WhyChooseGermanyProps> = ({
  title = "Why Choose Germany with Global Health Opulence",
  description =
    "Through Global Health Opulence, your Germany healthcare travel experience combines world-leading medical expertise with seamless coordination across Europe. Our partnerships with Germany's top university hospitals and specialized clinics ensure access to pioneering treatments, transparent pricing, and comprehensive aftercare. From visa support and language assistance to private recovery accommodations and cultural experiences, we orchestrate every detail for a truly restorative journey in the heart of Europe.",
  imageSrc = "/Doctor.png",
  imgAlt = "Doctor",
}) => {
...
export default WhyChooseGermany;
